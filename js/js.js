...
function factorial(n) {
  ...
  console.log("4)");
  console.log(shortWord("пример", 4));
  ...
  console.log("6)");
  console.log(copyArray([1, 2, 2], [4, 5], 1));
  ...
  console.log("7)");
  console.log(arrayWithoutFalsy([1, 0, "", "", false, NaN, "" ,undefined, 43, "", "", 0, 1, 5]));
  ...
  console.log("8)");
  console.log(stringLetters(["кееееsdfееек", "LAккккеееееdsfеееееg"]));
